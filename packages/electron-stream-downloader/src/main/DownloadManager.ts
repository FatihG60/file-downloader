...
import { DownloaderEngine } from './DownloaderEngine.js'
import { DownloadProgress, StartDownloadParams } from '../types.js'
...
export class DownloadManager {
  ...
  public startDownload(params: StartDownloadParams): DownloadProgress {
    ...
    const destination = params.destinationFolder || process.cwd()
